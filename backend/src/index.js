...
async function main (){
    ...
    const mongoConnetion = await Mongo.connect({
        mongoConnectionString: "mongodb+srv://mateusUser:naruto741@mygastronomy-cluster.ull2c.mongodb.net/?retryWrites=true&w=majority&appName=mygastronomy-cluster,",
        mongoDbName: "mygastronomy-cluster"
    }) //conecta ao banco de dados chamando o método connect do objeto Mongo
    console.log(mongoConnetion) //imprime o resultado da conexão com o banco de dados
